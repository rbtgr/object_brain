...
class ShainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shain" do
    assert_difference('Shain.count') do
      post shains_url, params: { shain: { kihonkyu: @shain.kihonkyu, name: @shain.name, yakusyoku: @shain.yakusyoku } }
    end
  ...
  test "should update shain" do
    patch shain_url(@shain), params: { shain: { kihonkyu: @shain.kihonkyu, name: @shain.name, yakusyoku: @shain.yakusyoku } }
